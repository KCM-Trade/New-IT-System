...
export const enUS = {
  ...
  loginIpsPage: {
    ...
    tradeProfit: {
      ...
      rule: "An IP used by {count} or more different clients is listed. One client with several accounts is not.",
      ...
      colSharedIpsTip:
        "IPs used by at least two accounts in the group. Only an IP used by {count} or more different clients connects accounts.",
      ...
      empty: "No such IP in this window",
      emptyHint:
        "{from} ~ {to}. An IP has to be used by {count} or more different clients to show up.",
