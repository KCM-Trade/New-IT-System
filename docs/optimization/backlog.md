...
| [OPT-0062](./items/OPT-0062-intraday-return-rule.md) | P1 | mixed | L | 即日高收益率自動偵測與郵件警報：risk-monitor 新規則 Intraday Return（band 131-140）+ detail 表 + 郵件源；公式改分母 = 昨日日終權益 + 當日入金 + 50/100 USD 地板；100% 匯總 / 300% 即發；待用戶拍板 2 項（見 item） |
